...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ...
        ConfirmationTokenModel confirmationToken = confirmationTokenService
                                                        .getToken(token)
                                                        .orElseThrow(() -> 
                                                            new IllegalStateException("Token not found!"));

        if (confirmationToken.getConfirmedAt() != null) {
            throw new IllegalStateException("token already has confirmed!");
        }
        ...
        userService.enableUserModel(confirmationToken.getUserModel());
